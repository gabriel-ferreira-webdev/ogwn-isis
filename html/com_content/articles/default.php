...
if ($grouplist == "Super Users") {
								 echo JHtml::_('contentadministrator.featured', $item->featured, $i, $canChange);
								 ?>
<script type="text/javascript">
var toolbarfeature = document.querySelector("#toolbar-featured");
var toolbarunfeature = document.querySelector("#toolbar-unfeatured");
var featuredlink = document.querySelector("#submenu li:nth-child(3)");
featuredlink.style.display = "inline-block";
toolbarfeature.style.display = "inline-block";
toolbarunfeature.style.display = "inline-block";
</script>
