...
var featuredlabel = document.querySelector("#jform_featured-lbl");
var	featuredcntrl = document.querySelector("#jform_featured");
var images = document.getElementById("images").querySelectorAll(".control-group");
console.log(images);
featuredlabel.style.display = "inline-block";
featuredcntrl.style.display = "inline-block";
