...
var menuFeatured = document.querySelector(".menu-featured");
 menuFeatured.style.display = "inline-block";
 menuFeatured.style.position = "static";
 menuFeatured.style.pointerEvents = "all";
}
